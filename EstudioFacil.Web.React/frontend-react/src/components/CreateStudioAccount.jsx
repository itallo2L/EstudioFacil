    ...
    return (
        <div className="w-screen h-screen bg-white flex items-center justify-center gap-20">
            <div className="flex-container items-center justify-center mb-52">
                ...
                <div className="flex">
                    <p className="p-2 mb-2 h-8 flex items-center font-mono font-bold text-xl">Nome Fantasia</p>
                </div>
                ...
                <div className="flex">
                    <p className="p-2 mb-2 h-8 flex items-center font-mono font-bold text-xl">Razão Social</p>
                </div>
                <div className="flex mb-6">
                    <input
                        className="w-full p-2 rounded-full border border-gray-400"
